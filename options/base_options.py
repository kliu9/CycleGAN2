...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--netD1', type=str, default='basic',
        ...
        parser.add_argument('--netD2', type=str, default='basic',
                            help='specify discriminator architecture [basic | n_layers | pixel]. The basic model is a 70x70 PatchGAN. n_layers allows you to specify the layers in the discriminator')
        parser.add_argument('--netG1', type=str, default='resnet_9blocks',
                            help='specify generator architecture [resnet_9blocks | resnet_6blocks | unet_256 | unet_128]')
        parser.add_argument('--netG2', type=str, default='resnet_9blocks',
                            help='specify generator architecture [resnet_9blocks | resnet_6blocks | unet_256 | unet_128]')
        ...
        parser.add_argument('--saved_DA', type=str, default='',
                            help='preload saved weights for discriminator')
        # dataset parameters
