...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--train_D', action="store_true",
                            default=False, help='Train only discriminator')
        ...
        parser.add_argument('--save_DA', type=str,
                            default='', help='train, val, test, etc')
        # training parameters
        parser.add_argument('--n_epochs', type=int, default=2,
                            help='number of epochs with the initial learning rate')
        parser.add_argument('--n_epochs_decay', type=int, default=2,
